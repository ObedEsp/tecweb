...
// Consulta SQL para obtener productos con unidades menores o iguales al tope y no eliminados
$query = "SELECT * FROM productos WHERE unidades <= ? AND eliminado = 0";
...
<body>
    ...
    <?php else: ?>
        <script>
            alert('No hay productos con unidades menores o iguales a <?= $tope ?> y que no estén eliminados.');
        </script>
    <?php endif; ?>
</body>
</html>
